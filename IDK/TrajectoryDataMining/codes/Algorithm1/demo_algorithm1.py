...
import pandas as pd
import datetime
from codes.Algorithm1.mp_idk2 import *
...
#parameter search
#mp_idk2(alltjlist, labels)
#run_idk2(alltjlist,labels, 2,2)

idkscore = idk_square(alltjlist, psi1=2, psi2=4)
auc = roc_auc_score(labels, idkscore)
print("auc: ", auc)
...
res = []
for i in range(10):
    auc = run_idk2(alltjlist, labels, 2, 4)
    res.append(auc)
